...
| <a name="module_ecs_codepipeline"></a> [ecs\_codepipeline](#module\_ecs\_codepipeline) | cloudposse/ecs-codepipeline/aws | 0.28.7 |
...
| <a name="input_codepipeline_codestar_connection_arn"></a> [codepipeline\_codestar\_connection\_arn](#input\_codepipeline\_codestar\_connection\_arn) | Codestar ARN, to use instead of 'github_oauth_token'. This will set up the 'source' stage to use the "Github Version 2" integration. | `string` | `""` | no |
