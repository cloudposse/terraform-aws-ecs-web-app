...
module "ecs_alarms" {
  ...
  service_name                 = "${module.ecs_alb_service_task.service_name}"
  cpu_utilization_threshold    = "${var.ecs_alarms_cpu_util_threshold}"
  memory_utilization_threshold = "${var.ecs_alarms_mem_util_threshold}"
...
module "alb_ingress_alarms" {
  ...
  create_sns_topic               = "false"
  sns_topic_name                 = "${var.sns_topic_name}"
  alb_name                       = "${var.alb_alarms_alb_name}"
  alb_arn_suffix                 = "${var.alb_alarms_alb_arn_suffix}"
